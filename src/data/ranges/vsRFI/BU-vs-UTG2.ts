...
// PLACEHOLDER: Using BU vs HJ range data as placeholder for BU vs UTG+1
const BU_vs_UTG2_RFI: RangeData = {
  positionCombo: 'BU_vs_UTG+1_RFI',
  hands: {
