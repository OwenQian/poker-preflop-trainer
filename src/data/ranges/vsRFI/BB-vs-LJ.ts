/**
 * Big Blind vs LJ RFI Range, LJ RFI size of 2.25bb (picked this size to allow a decently wide range but cut down on range width)
 * 
...
const BB_vs_LJ_RFI: RangeData = {
  ...
  hands: {
    ...
    '32s': { raise: 0, call: 25, fold: 75 },
    'K2s': { raise: 0, call: 50, fold: 50 },
    'Q2s': { raise: 0, call: 0, fold: 100 },
    'Q3s': { raise: 0, call: 0, fold: 100 },
    'Q4s': { raise: 0, call: 0, fold: 100 },
    'Q5s': { raise: 0, call: 25, fold: 75 },
    ...
    'KJo': { raise: 0, call: 50, fold: 50 },
    'QJo': { raise: 25, call: 50, fold: 25 },
