...
// UTG (Under the Gun) RFI Range - ~10.5%
export const UTG_RFI: RangeData = {
  ...
  hands: {
    ...
    '66': { raise: 50, call: 0, fold: 50 },  // Light red
    '55': { raise: 50, call: 0, fold: 50 },  // Light red
    ...
    'AJo': { raise: 50, call: 0, fold: 50 },  // Light red
    ...
    'A5s': { raise: 50, call: 0, fold: 50 },  // Light red
    ...
    'KJo': { raise: 0, call: 0, fold: 100 },  // Light red
    ...
    'QJo': { raise: 0, call: 0, fold: 100 },  // Light red
    ...
    // Ten hands
    'T9s': { raise: 50, call: 0, fold: 50 },  // Light red
