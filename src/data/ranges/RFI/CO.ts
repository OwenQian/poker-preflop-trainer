 ...
 * CO (Cutoff) RFI Range
 * 
 * This is the Raise First In range for the CO position (late position).
 * CO should play a loose range of approximately 20-25% of hands.
 * 
