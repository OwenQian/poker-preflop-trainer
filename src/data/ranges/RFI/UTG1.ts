/**
 * UTG+1 (Under the Gun +1) RFI Range
 * 
 * This is the Raise First In range for the UTG+1 position (second to act preflop).
 * UTG+1 should play a tight range of approximately 10.5% of hands.
 * 
