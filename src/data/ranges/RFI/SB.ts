/**
 * SB (Small Blind) RFI Range
 * 
 * This is the Raise First In range for the SB position (small blind).
 * SB should play a wide range of approximately 35-40% of hands when first to act.
 * Note: This is different from SB vs BB when facing action from other positions.
 * 
