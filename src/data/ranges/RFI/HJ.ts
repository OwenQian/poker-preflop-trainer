/**
 * HJ (Highjack) RFI Range
 * 
 * This is the Raise First In range for the HJ position (late-middle position).
 * HJ should play a moderately loose range of approximately 15-17% of hands.
 * 
